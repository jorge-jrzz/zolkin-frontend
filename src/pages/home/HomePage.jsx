          ...
          <div style={{ width: "93.75%" }} className="column">
            <h1 className="">
              <mark className="highlight-default">
                Usa Zolkin para controlar Gmail y Google Calendar
              </mark>
            </h1>
            <div className="column-list">
            ...
            <h1>Ejemlpos</h1>
            <figure
              className="block-color-blue_background callout"
              ...
              <div style={{ width: "100%" }}>
                <div className="column-list">
                  <div style={{ width: "50%" }} className="column">
                    <figure
                      className="block-color-default callout"
                      style={{ whiteSpace: "pre-wrap", display: "flex" }}
                    >
                      <div style={{ width: "100%" }}>
                        <ExampleChat
                          usermessage="Crea un evento en Calendar para ir a cenar hoy con mi mamá a las 7:30pm"
                          aimessage="He creado el evento para la cena con tu mamá hoy a las 7:30 PM. Puedes verlo en tu calendario. ¡Disfruten de la cena!"
                        />
                      </div>
                    </figure>
                  </div>
                  <div style={{ width: "50%" }} className="column">
                    ...
                    >
                      <div style={{ width: "100%" }}>
                        <ExampleChat
                          usermessage="Crear un borrador en Gmail para avisarle a mi asesor que hoy no podremos reunirnos"
                          aimessage="He creado un borrador en Gmail para avisarle a tu asesor que no podrán reunirse hoy. Puedes revisarlo y enviarlo cuando desees."
                        />
                      </div>
                    </figure>
                  </div>
            ...
            <div className="column-list">
              <div style={{ width: "93.75%" }} className="column">
                <div className="column-list">
                  <div style={{ width: "12.5%" }} className="column">
                    <figure
                      className="image"
                  ...
                  <div style={{ width: "93.75%" }} className="column">
                    <h3>
                      <mark className="highlight-default">
                        ...
                        respuestas contextuales y relevantes en cada interacción
                      </mark>
                    </h3>
                  </div>
                </div>
              ...
              <div style={{ width: "100%" }}>
                <div className="column-list">
                  <div style={{ width: "37.5%" }} className="column">
                    <h1 style={{ fontSize: "1.6rem", whiteSpace: "nowrap" }}>
                      Aplicación potenciada por Inteligencia Artificial
                      Generativa
                    </h1>
                  ...
                  <div
                    style={{ width: "62.5%", marginTop: "6.5rem" }}
                    className="column"
                  >
                    <p>
                      <strong>
                        Lleva tu productividad al siguiente nivel con la magia
                        de la IA.
                      </strong>
                    </p>
                    <br />
                    <p className="">
                      Zolkin utiliza tecnología de vanguardia en Inteligencia
                      Artificial Generativa para comprender tus palabras,
                      anticiparse a tus necesidades y simplificar tus tareas. Ya
                      sea creando eventos en Google Calendar o redactando
                      correos en Gmail, Zolkin traduce tus ideas en acciones
                      concretas, ahorrándote tiempo y esfuerzo.
                    </p>
                  </div>
                </div>
                <p className="" />
            ...
            <br />
            <h3 style={{ fontSize: "25px" }}>Redes</h3>
            <SocialMediaTooltip />
          </div>
          <div style={{ width: "6.25%" }} className="column"></div>
        </div>
      </div>
    </PageWrapper>
  );
...
const InitCardSyles = styled.div`
  .zolkin-crad {
    margin-top: 4em;
  }
`;
