...
const SocialMediaTooltip = () => {
  return (
    ...
    <a
      href="https://linkedin.com/in/jorge-jrzz"
      aria-label="LinkedIn"
  ...
  <li class="icon-content">
    <a href="https://github.com/jorge-jrzz" aria-label="GitHub" data-social="github">
      <div class="filled"></div>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
  ...
  <li class="icon-content">
    <a
      href="https://www.instagram.com/jorgejrzz"
  ...
  <li class="icon-content">
    <a href="https://www.youtube.com/@jorge-jrzz" aria-label="Youtube" data-social="youtube">
      <div class="filled"></div>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
    ...
    <div class="tooltip">Youtube</div>
        ...
        <li className="icon-content">
          <a href="https://t.me/BAZKETO" aria-label="Telegram" data-social="telegram">
